...
build = {
    type = "builtin",
    modules = {
    ["kong.plugins.oidc.migrations"] = "kong/plugins/oidc/migrations/init.lua",
    ["kong.plugins.oidc.migrations.postgres"] = "kong/plugins/oidc/migrations/postgres.lua",
    ...
    ["kong.plugins.oidc.daos"] = "kong/plugins/oidc/daos.lua"
    }
}
